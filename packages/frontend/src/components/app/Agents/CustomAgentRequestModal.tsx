...
const FORMSPREE_ID = process.env.NEXT_PUBLIC_CUSTOM_AGENT_FORMSPREE_ID ?? "";
...
export const CustomAgentRequestModal: FunctionComponent<Props> = ({
  onClose,
  open,
}) => {
  ...
  const onSubmit = useCallback(async () => {
    ...
    formData.append("useCaseDetails", values.useCaseDetails);
    ...
    try {
      ...
      if (!response.ok) {
        ...
        notification.success({
          message: "Success",
          description: "Your custom agent request has been submitted! We'll be in touch soon to discuss your requirements.",
        });
        onClose();
      }
    } catch (e) {
  ...
  return (
    <Modal
      ...
      width={620}
      footer={null}
      title={<h2 className="text-xl font-bold">Request a Custom Agent</h2>}
      ...
      {open && user && (
        <>
          <p className="mb-3 text-muted-foreground">
            Tell us about the custom agent you need, and our team will work with you to build it.
          </p>
          ...
          >
            ...
            <Form.Item
              ...
              label="Briefly describe the agent you need"
              className="w-full mb-1"
              rules={[
                {
                  type: "string",
                  required: true,
                  message: "Please describe the agent you're requesting",
                  min: 10,
                },
              ]}
            >
              <Input.TextArea
                placeholder="E.g., A document summarisation agent that can process legal contracts"
                size="middle"
                className="w-full"
                autoSize={{ minRows: 2 }}
              />
            ...
            >
              <Input.TextArea
                placeholder="Describe your workflow, specific requirements, and what you want the agent to accomplish..."
                size="middle"
                className="w-full"
            ...
            <Form.Item 
              ...
              className="w-full mb-1"
              help="You can upload images, diagrams or documents to help explain your requirements"
            >
              <Upload
                beforeUpload={() => false}
                maxCount={1}
            ...
            <div className="flex justify-end flex-wrap-reverse items-stretch sm:items-center gap-3 mt-3">
              <Button
...
export default CustomAgentRequestModal;
