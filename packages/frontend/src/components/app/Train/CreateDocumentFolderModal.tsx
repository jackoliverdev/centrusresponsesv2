...
import { useCreateDocumentFolder } from "@/hooks/document/useCreateDocumentFolder";
...
export const CreateDocumentFolderModal: FunctionComponent<Props> = ({
  open,
  onClose,
  onSuccess,
}) => {
    ...
    createFolder(
      { ...data, name: name.trim() },
      {
        onSuccess: (response) => {
          ...
          return void message.success("Document folder created successfully.");
        },
        onError: () =>
